                ...
                <div class="card" v-for="task in ms.tasks" style="cursor: pointer">
                  <div class="card-header" id="headingOne" data-toggle="collapse"
                    ...
                    <p class="mb-0 d-flex justify-content-between align-items-center font-weight-bold text-danger">
                      {{task.title}}
                      <span class="badge badge-dark badge-pill mr-0">points: {{task.points}}</span>
                      <button class="btn btn-outline-secondary" type="button" id="button-addon2">Complete Task</button>
                    </p>
                  </div>
